...
const eventsData = [
  {
    ...
    description: "Join us for our annual dog show where dogs of all breeds compete for Best in Show. Categories include obedience, agility, and conformation. The day will be filled with demonstrations, competitions, and opportunities for dog owners to showcase their pets' talents and beauty.\n\nEvents include:\n- Breed conformation competitions\n- Obedience trials\n- Agility demonstrations\n- Best puppy categories\n- Handler competitions\n\nLocal vendors will be present with food, drinks, and dog-related merchandise. This is a family-friendly event with activities for children as well.",
    category: "Competition",
    attending: 152,
    featured: true,
    organizer: "CustomK9 Kenya",
    price: "Ksh 500 per entry, Ksh 200 for spectators",
    contact: "events@customk9kenya.com",
    website: "https://www.customk9kenya.com/events/annual-dog-show",
    schedule: [
      { time: "8:00 AM - 9:00 AM", activity: "Registration and check-in" },
      { time: "9:00 AM - 10:30 AM", activity: "Puppy categories (under 12 months)" },
      { time: "10:30 AM - 12:00 PM", activity: "Breed conformation - Small breeds" },
      { time: "12:00 PM - 1:00 PM", activity: "Lunch break and demonstrations" },
      { time: "1:00 PM - 2:30 PM", activity: "Breed conformation - Large breeds" },
      { time: "2:30 PM - 3:30 PM", activity: "Obedience and agility competitions" },
      { time: "3:30 PM - 4:00 PM", activity: "Best in Show and awards ceremony" }
    ]
  },
  {
    id: 2,
    ...
    description: "A workshop designed to help puppy owners understand the importance of early socialization and how to properly socialize their puppies. This hands-on workshop will provide guidance on creating positive experiences for your puppy during the critical socialization period (between 8-16 weeks).\n\nTopics covered include:\n- Understanding the importance of socialization\n- Creating positive experiences with people, other dogs, and environments\n- Reading your puppy's body language\n- Safe handling and introduction techniques\n- Preventing fear and anxiety issues\n\nParticipants will practice real socialization scenarios in a controlled environment under trainer supervision. All puppies must have their first set of vaccinations and be under 6 months old.",
    category: "Workshop",
    attending: 45,
    featured: true,
    organizer: "CustomK9 Kenya",
    price: "Ksh 2,500 per puppy (one handler included)",
    contact: "training@customk9kenya.com",
    website: "https://www.customk9kenya.com/workshops/puppy-socialization",
    schedule: [
      { time: "9:30 AM - 10:00 AM", activity: "Check-in and settling time" },
      { time: "10:00 AM - 10:30 AM", activity: "Introduction to socialization principles" },
      { time: "10:30 AM - 11:15 AM", activity: "Guided socialization exercises" },
      { time: "11:15 AM - 11:45 AM", activity: "Q&A and individual assistance" },
      { time: "11:45 AM - 12:00 PM", activity: "Wrap-up and take-home resources" }
    ]
  },
  // Additional events would be here, matching the structure in the main events page
  {
    id: 3,
